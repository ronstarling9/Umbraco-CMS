...
public abstract class TemplateQueryControllerBase : TemplateControllerBase
{
    ...
    {
        new() { Operator = Operator.Equals, ApplicableTypes = new[] { TemplateQueryPropertyType.Integer,
            TemplateQueryPropertyType.String } },
        new() { Operator = Operator.NotEquals, ApplicableTypes = new[] { TemplateQueryPropertyType.Integer,
            TemplateQueryPropertyType.String } },
        new() { Operator = Operator.LessThan, ApplicableTypes = new[] { TemplateQueryPropertyType.Integer,
            TemplateQueryPropertyType.DateTime } },
        new() { Operator = Operator.LessThanEqualTo, ApplicableTypes = new[] { TemplateQueryPropertyType.Integer,
            TemplateQueryPropertyType.DateTime } },
        new() { Operator = Operator.GreaterThan, ApplicableTypes = new[] { TemplateQueryPropertyType.Integer,
            TemplateQueryPropertyType.DateTime } },
        new() { Operator = Operator.GreaterThanEqualTo, ApplicableTypes = new[] { TemplateQueryPropertyType.Integer,
            TemplateQueryPropertyType.DateTime } },
    ...
    protected IEnumerable<TemplateQueryPropertyPresentationModel> GetProperties()
        => new TemplateQueryPropertyPresentationModel[]
    {
