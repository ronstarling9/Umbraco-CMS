...
/// </summary>
internal sealed class AllowedApplicationHandler
    : MustSatisfyRequirementAuthorizationHandler<AllowedApplicationRequirement>
{
    ...
    protected override Task<bool> IsAuthorized(
        ...
        AllowedApplicationRequirement requirement)
    {
